...
export function PlacementsClient({ 
  ...
  ctcData: any[], 
  topCompanies: any[],
  totalOffers25: number,
  highestCTC25: number,
  highestCompany25: string,
  avgCTC25: string
}) {
    ...
    <div className="p-8 max-w-7xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-primary text-primary-foreground p-6 rounded-3xl shadow-lg relative overflow-hidden">
          ...
          <h3 className="text-4xl font-heading font-semibold">{selectedYear === '2025-26' ? totalOffers25 : '--'}</h3>
        ...
        <div className="bg-white p-6 rounded-3xl border border-border shadow-sm">
          ...
          <p className="text-muted-foreground font-medium mb-1">Highest CTC ({selectedYear})</p>
          <h3 className="text-4xl font-heading font-semibold text-emerald-600">
            ₹{selectedYear === '2025-26' ? highestCTC25 : '--'}
            <span className="text-xl text-muted-foreground ml-1">LPA</span>
          </h3>
          <p className="text-sm mt-4 font-medium text-muted-foreground">
            {selectedYear === '2025-26' ? highestCompany25 : '--'}
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-border shadow-sm">
          ...
          <p className="text-muted-foreground font-medium mb-1">Average CTC ({selectedYear})</p>
          <h3 className="text-4xl font-heading font-semibold text-blue-600">
            ₹{selectedYear === '2025-26' ? avgCTC25 : '--'}
            <span className="text-xl text-muted-foreground ml-1">LPA</span>
          </h3>
          <p className="text-sm mt-4 font-medium text-muted-foreground">Across Top Companies</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-border shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-heading font-semibold">Top Recruiters (All Time)</h3>
